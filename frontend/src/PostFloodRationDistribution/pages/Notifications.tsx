...
import { filterOutSeedNotifications } from "../utils/filterSeedData";
...
export default function Notifications() {
  ...
  const typeIcons: Record<string, string> = {
    priority_alert: "analytics",
    disease_alert: "coronavirus",
    low_stock: "inventory",
    route_alert: "route",
    delivery_alert: "local_shipping",
    system: "settings",
  };
  ...
  return (
    <div>
      <PageHeader
        ...
        actions={
          unread.length > 0 ? (
            <PrimaryButton onClick={handleMarkAllRead} icon="done_all">
              Mark All Read
            </PrimaryButton>
          ) : undefined
        }
