...
export const Permissions = {
  ...
  canAccessPage: (role: string, page: string): boolean => {
    ...
    const roleMap: Record<UserRole, string[]> = {
      admin: ['dashboard', 'map', 'safe-zones', 'camps', 'camp-priority', 'item-priority', 'resources', 'distribution-centers', 'rescue-centers', 'route-planning', 'rescue-operations', 'distributions', 'ml-retraining', 'reports', 'notifications', 'need-reports'],
      disaster_officer: ['dashboard', 'map', 'safe-zones', 'camps', 'camp-priority', 'item-priority', 'resources', 'distribution-centers', 'rescue-centers', 'route-planning', 'rescue-operations', 'distributions', 'ml-retraining', 'reports', 'notifications', 'need-reports'],
  ...
  canManageRescueCenters: (role: string) => role ? ['admin', 'disaster_officer'].includes(role.toLowerCase()) : false,
